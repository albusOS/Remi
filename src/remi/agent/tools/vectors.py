...
class VectorToolProvider(ToolProvider):
    def __init__(
        self,
        ...
        *,
        ...
        self._entity_type_hint = entity_type_hint
        self._scope_filter_args = scope_filter_args

    def register(self, registry: ToolRegistry) -> None:
        vs = self._vs
        emb = self._emb
        scope_filter_args = self._scope_filter_args
        ...
        if self._search_hint:
            base_desc = f"{base_desc} {self._search_hint}"

        entity_type_desc = self._entity_type_hint or "Filter by entity type"
