...
from remi.signals.tbox import MutableRulebook
from remi.observe.types import SpanKind, Tracer
from remi.evaluators.base import EntailmentResult
from remi.evaluators.base import signal_id as _signal_id
from remi.evaluators.delinquency import eval_manager_delinquency
from remi.evaluators.existence import eval_exists, eval_in_legal_track
from remi.evaluators.lease import eval_breach_detected, eval_manager_lease_cliff
from remi.evaluators.maintenance import eval_manager_maintenance_backlog
from remi.evaluators.portfolio import (
    eval_below_percentile,
    eval_manager_concentration_risk,
)
from remi.evaluators.threshold import eval_unit_threshold
from remi.evaluators.trend import (
