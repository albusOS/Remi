...
Pure MaintenanceRepository read-model.
"""
...
from remi.domain.core.portfolio.models import MaintenanceStatus
from remi.domain.core.portfolio.protocols import MaintenanceRepository
...
class MaintenanceQueryService:
    ...
    def __init__(self, property_store: MaintenanceRepository) -> None:
