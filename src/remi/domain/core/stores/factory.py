...
from remi.domain.monitoring.snapshots.rollups import RollupStore
from remi.domain.core.stores.rollups import InMemoryRollupStore, PostgresRollupStore
...
def build_property_store(
    ...
    if backend == "postgres":
        ...
        from remi.domain.core.stores.pg import PostgresPropertyStore
