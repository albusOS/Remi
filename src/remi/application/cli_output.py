...
Lives in ``application/`` so that vertical-slice CLI modules
(``application/portfolio/cli.py``, etc.) can import without reaching
into ``shell/``.  ``shell/cli/output.py`` re-exports for backward
compatibility.
"""
