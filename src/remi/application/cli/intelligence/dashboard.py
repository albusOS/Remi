...
class _SignalPanel(Static):
    ...
    def __init__(self) -> None:
        super().__init__()
        self._content = "[dim]No signals yet[/dim]"
...
class RemiDashboard(App):  # type: ignore[type-arg]
    ...
    BINDINGS = [
        Binding("r", "run_pipeline", "Refresh signals", show=True),
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="main-row"):
            ...
            with Vertical(id="right-col"):
                ...
                yield Input(
                    placeholder="you>  ask anything… (r = refresh signals, ctrl+c = quit)",
                    id="chat-input",
                )
        yield Footer()
    ...
    async def _refresh_signals(self) -> None:
        ...
        try:
            ...
            self._log_activity(f"  [red]✗ Signal refresh error:[/red] {exc}")
