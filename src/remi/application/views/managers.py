"""ManagerResolver — director-level portfolio aggregation."""
...
class ManagerResolver:
    ...
    async def aggregate_manager(self, manager_id: str) -> ManagerSummary | None:
        ...
        # Delinquency from BalanceObservations — get latest per tenant
...
def _latest_obs_by_tenant(obs_list: list) -> dict[str, object]:
    """Return the most recent BalanceObservation per tenant_id."""
