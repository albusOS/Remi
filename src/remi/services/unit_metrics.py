"""Canonical unit-level classification helpers.

Layer 3 (Services): shared business rules for occupancy, vacancy,
loss-to-lease, maintenance status, and below-market classification.

Every service that needs to classify a unit (snapshots, dashboard,
manager_review, rent_roll) should use these functions so the rules
